...
namespace Tailenders.Controls.RangeSlider
{
    ...
    public class RangeSliderView : View
    {
        public static readonly BindableProperty LowerValueProperty =
            BindableProperty.Create(nameof(LowerValue), typeof(float), typeof(RangeSliderView), 0f, defaultBindingMode: BindingMode.TwoWay);

        public static readonly BindableProperty MaximumValueProperty =
            BindableProperty.Create(nameof(MaximumValue), typeof(float), typeof(RangeSliderView), 0f);

        public static readonly BindableProperty MaxThumbHiddenProperty =
            BindableProperty.Create(nameof(MaxThumbHidden), typeof(bool), typeof(RangeSliderView), false);

        public static readonly BindableProperty MaxThumbTextHiddenProperty =
           BindableProperty.Create(nameof(MaxThumbTextHidden), typeof(bool), typeof(RangeSliderView), false);

        public static readonly BindableProperty MinimumValueProperty =
            BindableProperty.Create(nameof(MinimumValue), typeof(float), typeof(RangeSliderView), 0f);

        public static readonly BindableProperty MinThumbHiddenProperty =
            BindableProperty.Create(nameof(MinThumbHidden), typeof(bool), typeof(RangeSliderView), false);

        public static readonly BindableProperty MinThumbTextHiddenProperty =
            BindableProperty.Create(nameof(MinThumbTextHidden), typeof(bool), typeof(RangeSliderView), false);

        public static readonly BindableProperty StepValueContinuouslyProperty =
            BindableProperty.Create(nameof(StepValueContinuously), typeof(bool), typeof(RangeSliderView), false);

        public static readonly BindableProperty StepValueProperty =
            BindableProperty.Create(nameof(StepValue), typeof(float), typeof(RangeSliderView), 0f);

        public static readonly BindableProperty UpperValueProperty =
            BindableProperty.Create(nameof(UpperValue), typeof(float), typeof(RangeSliderView), 0f, defaultBindingMode: BindingMode.TwoWay);

        public static readonly BindableProperty BarHeightProperty =
            BindableProperty.Create(nameof(BarHeight), typeof(int?), typeof(RangeSliderView));

        public static readonly BindableProperty ShowTextAboveThumbsProperty =
            BindableProperty.Create(nameof(ShowTextAboveThumbs), typeof(bool), typeof(RangeSliderView), false);

        public static readonly BindableProperty TextSizeProperty =
            BindableProperty.Create(nameof(TextSize), typeof(double), typeof(RangeSliderView), 10D);

        public static readonly BindableProperty TextFormatProperty =
            BindableProperty.Create(nameof(TextFormat), typeof(string), typeof(RangeSliderView), "F0");

        public static readonly BindableProperty TextColorProperty =
            BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(RangeSliderView), Color.Default);

        public static readonly BindableProperty FormatLabelProperty =
            BindableProperty.Create(nameof(FormatLabel), typeof(Func<Thumb, float, string>), typeof(RangeSliderView));

        public static readonly BindableProperty ActiveColorProperty =
            BindableProperty.Create(nameof(ActiveColor), typeof(Color), typeof(RangeSliderView), Color.Default);

        public static readonly BindableProperty MaterialUiProperty =
            BindableProperty.Create(nameof(MaterialUI), typeof(bool), typeof(RangeSliderView), false);
